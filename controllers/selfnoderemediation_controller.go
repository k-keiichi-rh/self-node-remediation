...
func (r *SelfNodeRemediationReconciler) remediateWithResourceRemoval(snr *v1alpha1.SelfNodeRemediation, removeResource func(*v1.Node) (time.Duration, error)) (ctrl.Result, error) {
...
func (r *SelfNodeRemediationReconciler) removeResourceByResourceDeletion(node *v1.Node) (time.Duration, error) {
	//fence
	zero := int64(0)
...
func (r *SelfNodeRemediationReconciler) removeResourceByAddingOutOfServiceTaint(node *v1.Node) (time.Duration, error) {
