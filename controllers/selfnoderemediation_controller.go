...
func (r *SelfNodeRemediationReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	case v1alpha1.OutOfServiceTaintRemediationStrategy:
		result, err = r.remediateByAddingOutOfServiceTaint(snr)
	default:
...
func (r *SelfNodeRemediationReconciler) remediateWithResourceRemoval(snr *v1alpha1.SelfNodeRemediation, removeResource func(*v1.Node, *v1alpha1.SelfNodeRemediation) (time.Duration, error)) (ctrl.Result, error) {
	...
	if waitTime, err := removeResource(node, snr); err != nil {
		return ctrl.Result{}, err
	} else if waitTime != 0 {
...
func (r *SelfNodeRemediationReconciler) removeResourceByResourceDeletion(node *v1.Node, snr *v1alpha1.SelfNodeRemediation) (time.Duration, error) {
	//fence
	zero := int64(0)
...
func (r *SelfNodeRemediationReconciler) remediateByAddingOutOfServiceTaint(snr *v1alpha1.SelfNodeRemediation) (ctrl.Result, error) {
	return r.remediateWithResourceRemoval(snr, r.removeResourceByAddingOutOfServiceTaint)
}

func (r *SelfNodeRemediationReconciler) removeResourceByAddingOutOfServiceTaint(node *v1.Node, snr *v1alpha1.SelfNodeRemediation) (time.Duration, error) {
